...
export RUBYLIB=$( "${VAGRANT_BIN_DIR}/ruby2.4" -e "puts $:.join(':').gsub('././', ENV['VAGRANT_USR_DIR'])")
...
new_ld_library_path="${VAGRANT_ROOT_DIR}/lib/x86_64-linux-gnu:${VAGRANT_ROOT_DIR}/usr/lib/x86_64-linux-gnu"
